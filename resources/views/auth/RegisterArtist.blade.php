...
<body>
	<div class="main">
		<div class="header" >
        <form class="form-horizontal" method="POST" action="/RegisterArtist"  enctype="multipart/form-data"> 
      {{ csrf_field() }}
			<h1>Creéz un compte artiste !</h1>
		</div>
				...
				<ul class="left-form" >
					...
					<li>
                    <input id="bio" type="text" name="bio" value="{{ old('bio') }}" required autofocus placeholder="Bio">
						<div class="clear"> </div>
					</li> 
					...
					<li>
					<label>Définir une photo de profil</label>
